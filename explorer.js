...
function SettingsController($scope, SharedService) {
    ...
    $scope.settings = {
        auth: 'auth', region: '', bucket: '', entered_bucket: 's3uploader-s3bucket-qvovxrmjr4lh', selected_bucket: '', view: 'folder', delimiter: '/', prefix: '',
    };
    $scope.settings.mfa = { use: 'no', code: '' };
    $scope.settings.cred = { accessKeyId: 'AKIA2R2DQMUTHF5VEZ25', secretAccessKey: '', sessionToken: '' };
